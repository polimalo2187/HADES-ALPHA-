...
function renderHome() {
  ...
  els.home.innerHTML = `
    <div class="section-grid">
      ...
      ${metricCard('Expectancy R', formatNumber(summary.expectancy_r || 0), 'Resultado esperado por señal')}
      ${metricCard('Max Drawdown', formatNumber(summary.max_drawdown_r || 0), 'Peor racha reciente')}
