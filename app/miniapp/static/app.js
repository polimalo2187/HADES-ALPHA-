...
function renderHome() {
  ...
  els.home.innerHTML = `
    <div class="section-grid">
      ${metricCard('Plan', me.plan_name || 'FREE', me.subscription_status_label || me.subscription_status || 'free')}
          ...
          return `
            <div class="item">
              <div class="item-header">
                ...
                <button class="button ${isCurrent ? 'button-secondary' : 'button-primary'}" data-create-order="${escapeHtml(planKey)}:${escapeHtml(item.days)}">${isCurrent ? 'Renovar' : 'Comprar'}</button>
              </div>
            </div>
          `;
        }).join('')}
  ...
  els.account.innerHTML = `
    <div class="section-grid">
      ...
      <div class="card card-span-12">
        ...
        <div class="action-row">
          <button class="button button-primary" data-goto="account">Gestionar plan</button>
        </div>
      </div>
