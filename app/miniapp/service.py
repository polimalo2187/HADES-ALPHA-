...
def _serialize_signal(doc: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "strategy_label": doc.get("strategy_label"),
...
def build_signal_detail_payload(user: Dict[str, Any], signal_id: str, *, profile_name: str = "moderado") -> Optional[Dict[str, Any]]:
    ...
    tracking_payload: Dict[str, Any] = {
        ...
        "strategy_key": tracking.get("strategy_key"),
        "strategy_label": tracking.get("strategy_label"),
        "strategy_family": tracking.get("strategy_family"),
        "entry_model_label": tracking.get("entry_model_label"),
        "strategy_summary": tracking.get("strategy_summary"),
        "live_summary": tracking.get("live_summary"),
        "action_label": tracking.get("action_label"),
        ...
        "entry_touched": bool(tracking.get("entry_touched")),
