...
def build_signal_tracking_text(payload: Dict, *, plan: str = "free") -> str:
...
def build_signal_tracking_keyboard(signal_id: str, *, source: str = "live", plan: str = "free") -> InlineKeyboardMarkup:
    if source == "live":
