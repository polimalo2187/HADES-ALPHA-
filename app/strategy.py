...
SCORE_CALIBRATION_VERSION = "v9_liquidity_close_market_ultra_soft_probe"
...
PREMIUM_PROFILE = {
    ...
    "atr_pct_min": 0.00005,
    "atr_pct_max": 0.0800,
    "liquidity_tolerance_atr": 1.20,
    "min_sweep_atr": 0.005,
    "min_rel_volume": 0.01,
    "min_confirm_rel_volume": 0.01,
    "min_wick_body_ratio": 0.15,
    "min_wick_range_ratio": 0.05,
    "min_confirm_body_ratio": 0.03,
    "entry_offset_atr": 0.06,
    "sl_buffer_atr": 0.11,
    "min_rr": 0.85,
    "min_barrier_rr": 0.20,
    "ema_reclaim_buffer_atr": 0.80,
    "max_countertrend_atr": 2.00,
    "min_pivots": 1,
    "min_sweep_range_atr": 0.05,
    "max_sweep_range_atr": 8.00,
    "max_risk_pct": 0.0500,
    "components": [
        "liquidity_zone",
        "minimum_sweep",
...
PLUS_PROFILE = {
    ...
    "atr_pct_min": 0.00002,
    "atr_pct_max": 0.1000,
    "liquidity_tolerance_atr": 1.60,
    "min_sweep_atr": 0.003,
    "min_rel_volume": 0.005,
    "min_confirm_rel_volume": 0.005,
    "min_wick_body_ratio": 0.10,
    "min_wick_range_ratio": 0.03,
    "min_confirm_body_ratio": 0.02,
    "entry_offset_atr": 0.08,
    "sl_buffer_atr": 0.13,
    "min_rr": 0.65,
    "min_barrier_rr": 0.12,
    "ema_reclaim_buffer_atr": 1.00,
    "max_countertrend_atr": 3.00,
    "min_pivots": 1,
    "min_sweep_range_atr": 0.03,
    "max_sweep_range_atr": 10.00,
    "max_risk_pct": 0.0800,
    "components": [
        "liquidity_zone",
        "minimum_sweep",
...
FREE_PROFILE = {
    ...
    "atr_pct_min": 0.0,
    "atr_pct_max": 0.1500,
    "liquidity_tolerance_atr": 2.20,
    "min_sweep_atr": 0.001,
    "min_rel_volume": 0.0,
    "min_confirm_rel_volume": 0.0,
    "min_wick_body_ratio": 0.05,
    "min_wick_range_ratio": 0.01,
    "min_confirm_body_ratio": 0.01,
    "entry_offset_atr": 0.09,
    "sl_buffer_atr": 0.15,
    "min_rr": 0.45,
    "min_barrier_rr": 0.05,
    "ema_reclaim_buffer_atr": 1.50,
    "max_countertrend_atr": 5.00,
    "min_pivots": 1,
    "min_sweep_range_atr": 0.01,
    "max_sweep_range_atr": 20.00,
    "max_risk_pct": 0.1200,
    "components": [
        "liquidity_zone",
        "minimum_sweep",
...
def _evaluate_direction(
    ...
    if len(historical) < LIQUIDITY_LOOKBACK:
        _record_reject(debug_counts, "history")
        return None
    ...
    if rel_volume < float(profile["min_rel_volume"]):
        _record_reject(debug_counts, "rel_volume")
        return None
    ...
    if not (float(profile["min_sweep_range_atr"]) <= sweep_range_atr <= float(profile["max_sweep_range_atr"])):
        _record_reject(debug_counts, "sweep_range")
        return None
    ...
    if model_nearest_barrier is not None:
        ...
        if model_barrier_rr < float(profile["min_barrier_rr"]):
            _record_reject(debug_counts, "barrier_room")
            return None
    ...
    if market_candidate is None:
        _record_reject(debug_counts, "market_entry")
        return None
...
def liquidity_sweep_reversal_strategy(
    ...
    if df[["atr", "atr_pct", "rel_volume", "body_ratio", "ema20", "ema50"]].tail(5).isnull().any().any():
        _record_reject(debug_counts, "nan_indicators")
        return None
