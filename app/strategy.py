...
SCORE_CALIBRATION_VERSION = "v17_liquidity_close_market_serious_filters_stepback1"
...
FREE_PROFILE = {
    ...
    "min_sweep_atr": 0.065,
    "min_rel_volume": 0.50,
    "min_confirm_rel_volume": 0.34,
    "min_wick_body_ratio": 0.68,
    ...
    "min_rr": 1.00,
    "min_barrier_rr": 0.56,
    "ema_reclaim_buffer_atr": 0.30,
    "max_countertrend_atr": 0.95,
    "min_pivots": 2,
    "min_sweep_range_atr": 0.34,
    "max_sweep_range_atr": 4.40,
    "max_risk_pct": 0.0260,
    "components": [
        "liquidity_zone",
        "minimum_sweep",
