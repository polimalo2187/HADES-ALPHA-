...
PLUS_RAW_SCORE_MIN = float(os.getenv("PLUS_RAW_SCORE_MIN", "77"))
FREE_RAW_SCORE_MIN = float(os.getenv("FREE_RAW_SCORE_MIN", "70"))
...
FREE_PROFILE = {
    ...
    "liquidity_tolerance_atr": breakout._env_float("LSR_FREE_LIQUIDITY_TOLERANCE_ATR", 0.54),
    "min_sweep_atr": breakout._env_float("LSR_FREE_MIN_SWEEP_ATR", 0.08),
    "min_rel_volume": breakout._env_float("LSR_FREE_MIN_REL_VOLUME", 0.72),
    "min_confirm_rel_volume": breakout._env_float("LSR_FREE_MIN_CONFIRM_REL_VOLUME", 0.74),
    "min_body_ratio_recovery": breakout._env_float("LSR_FREE_MIN_BODY_RATIO_RECOVERY", 0.15),
    "min_body_ratio_confirmation": breakout._env_float("LSR_FREE_MIN_BODY_RATIO_CONFIRMATION", 0.13),
    "min_close_position": breakout._env_float("LSR_FREE_MIN_CLOSE_POSITION", 0.49),
    "min_rr": breakout._env_float("LSR_FREE_MIN_RR", 0.85),
...
PLUS_PROFILE = {
    ...
    "liquidity_tolerance_atr": breakout._env_float("LSR_PLUS_LIQUIDITY_TOLERANCE_ATR", 0.48),
    "min_sweep_atr": breakout._env_float("LSR_PLUS_MIN_SWEEP_ATR", 0.11),
    "min_rel_volume": breakout._env_float("LSR_PLUS_MIN_REL_VOLUME", 0.78),
    "min_confirm_rel_volume": breakout._env_float("LSR_PLUS_MIN_CONFIRM_REL_VOLUME", 0.84),
    "min_body_ratio_recovery": breakout._env_float("LSR_PLUS_MIN_BODY_RATIO_RECOVERY", 0.18),
    "min_body_ratio_confirmation": breakout._env_float("LSR_PLUS_MIN_BODY_RATIO_CONFIRMATION", 0.16),
    "min_close_position": breakout._env_float("LSR_PLUS_MIN_CLOSE_POSITION", 0.54),
    "min_rr": breakout._env_float("LSR_PLUS_MIN_RR", 0.93),
...
PREMIUM_PROFILE = {
    ...
    "min_sweep_atr": breakout._env_float("LSR_PREMIUM_MIN_SWEEP_ATR", 0.15),
    "min_rel_volume": breakout._env_float("LSR_PREMIUM_MIN_REL_VOLUME", 0.86),
    "min_confirm_rel_volume": breakout._env_float("LSR_PREMIUM_MIN_CONFIRM_REL_VOLUME", 0.92),
    "min_body_ratio_recovery": breakout._env_float("LSR_PREMIUM_MIN_BODY_RATIO_RECOVERY", 0.21),
    "min_body_ratio_confirmation": breakout._env_float("LSR_PREMIUM_MIN_BODY_RATIO_CONFIRMATION", 0.19),
    "min_close_position": breakout._env_float("LSR_PREMIUM_MIN_CLOSE_POSITION", 0.59),
    "min_rr": breakout._env_float("LSR_PREMIUM_MIN_RR", 1.01),
