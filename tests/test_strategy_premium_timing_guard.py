...
def test_profile_rebalance_preserves_tier_hierarchy():
    assert strategy.PREMIUM_PROFILE["atr_pct_min"] >= strategy.PLUS_PROFILE["atr_pct_min"] >= strategy.FREE_PROFILE["atr_pct_min"]
    assert strategy.PREMIUM_PROFILE["atr_pct_max"] <= strategy.PLUS_PROFILE["atr_pct_max"] <= strategy.FREE_PROFILE["atr_pct_max"]
    assert strategy.PREMIUM_PROFILE["liquidity_tolerance_atr"] <= strategy.PLUS_PROFILE["liquidity_tolerance_atr"] <= strategy.FREE_PROFILE["liquidity_tolerance_atr"]
    assert strategy.PREMIUM_PROFILE["min_sweep_atr"] >= strategy.PLUS_PROFILE["min_sweep_atr"] >= strategy.FREE_PROFILE["min_sweep_atr"]
